...
const Sidbar = () => {
  return (
    <section className="bg-sidebarGray rounded-xl flex flex-col  p-4 h-full w-[330px]">
          ...
          <div>
            <ul className="my-2 mb-3">
              {sideBar.slice(0, 4).map((item) => (
                <li
                  key={item.id}
                  className="flexBetween text-textGray py-2 group hover:bg-[#EBEBEB] px-2 rounded-lg"
                >
                  <div>
